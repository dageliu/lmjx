    ...
    var _static = this.constructor;
        ...
        _private.prefix = _private.detectCSSPrefix().css;
           ...
           // ////////console.log(config['contentId']);
            var startBtn = null, moveBox = null, container = document.getElementById(config['contentId']),prizeBox = null;
            ...
            var faceInit = (function(){
                ...
                if(config.r){
                    ...
                    '"><div id="' + classes['hover'] + '" class="' + classes['hover'] + '"></div><div id="' + classes['prize'] + '" class="' + classes['prize'] + '"></div><div id="' + classes['start'] + '" class="' + classes['start'] + '"></div></div>';
                }else{
                    str = '<div id="swf' + classes['container'] +
                    '" class="' + classes['container'] +
                    '"><a hidefocus="true" id="' + classes['start'] + '" href="javascript:;" class="' + classes['start'] +
                    '"><div class="' + classes['slight'] +
                    '"></div></a><div id="' + classes['hover'] + '" class="' + classes['hover'] + '"></div><div id="' + classes['prize'] + '" class="' + classes['prize'] + '"></div></div>';
                }
                ...
                prizeBox= document.getElementById(classes['prize'])
                if(config.r){//调整坐标位置
            ...
            var moveNext = function(){
                ...
                moveBox.style.cssText = prizeBox.style.cssText = "display:block;left:"+curInfo.left+'px;top:'+curInfo.top+'px;';
            }

            var fastTime = 30, slowTime = 300, rdis = 8;
            this.reset = function(){
                btn.enable();
                moveBox.style.cssText = prizeBox.style.cssText = '';
            };
            ...
            this.stopRoll = function(id){
                ...
                if(myBrowser!="IE6"&&myBrowser!="IE7"&&myBrowser!="IE8"&&myBrowser!="IE8"&&myBrowser!="edge"){
                    ...
                    moveBox.style.cssText=prizeBox.style.cssText="-ms-transform: rotate("+ ((360-step[id]) + 360 * 10)+"deg); transform: rotateZ("+ ((360-step[id]) + 360 * 10)+"deg); transition:transform 5s cubic-bezier(0.35, -0.005, 0.565, 1.005) 0s;-ms-transition:transform 5s cubic-bezier(0.35, -0.005, 0.565, 1.005) 0s;";
                    // 动画结束时事件
                    function aniEnd(ele){
                        ele.addEventListener("transitionend", function() {
                            if(!animateEndBool) {
                                ele.style.cssText="-ms-transform: rotateZ("+ ((360-step[id]))+"deg); transform: rotateZ("+ ((360-step[id]))+"deg);";
                                if(ele==prizeBox){
